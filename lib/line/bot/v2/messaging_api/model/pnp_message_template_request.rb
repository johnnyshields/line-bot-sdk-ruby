  ...
  module Bot
    module V2
      module MessagingApi
        ...
        class PnpMessageTemplateRequest
          # @!attribute [rw] template_key
          #   @return [String] Specify the `Key` of the template you want to send.
          ...
          attr_accessor :to
          # @!attribute [rw] body
          #   @return [PnpMessageTemplateBody,nil] 
          attr_accessor :body
          ...
          # @param template_key [String] Specify the `Key` of the template you want to send.
          ...
          # @param body [PnpMessageTemplateBody, Hash[Symbol, untyped], nil] 
          ...
          def initialize(
            ...
            **dynamic_attributes
            ...
            @to = to
            @body = body.is_a?(Line::Bot::V2::MessagingApi::PnpMessageTemplateBody) || body.nil? ? body : Line::Bot::V2::MessagingApi::PnpMessageTemplateBody.create(**body) # steep:ignore
          ...
          # @return [Line::Bot::V2::MessagingApi::PnpMessageTemplateRequest] Instance of the class
